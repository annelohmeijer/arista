...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "fr_symbol_time_unique_constraint", "funding_rate", type_="unique"
    )
...
def downgrade() -> None:
    ...
    op.create_unique_constraint(
        "fr_symbol_time_unique_constraint",
        "funding_rate",
    ...
    op.create_table(
        "btc_30d_annualised_basis",
        sa.Column(
            "monthly_future_price",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "perpetual_future_price",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "datetime_", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
